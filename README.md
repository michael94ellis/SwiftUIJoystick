...
| shape        | JostickShape    | The shape of the Joystick's hitbox area, rectangluar or circular       Valid input: `.rect` or `.circle`         rect allows corner values (0,0), (0,width), (width,0), and (width,wdth)      circle limits monitor output to a circular radius from the Joystick's center   | no       |
